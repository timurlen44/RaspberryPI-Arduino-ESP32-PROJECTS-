...
wiringpi.pwmWrite(VerticalServoPin, _map(90, 0, 180,40, 260))
"""
...
Xposition = 90 # yatay pozisyon
Yposition = 90 # dikey pozisyon
pos_step = 1
sensivity = 40
...
def axis_control_thread():
    while True:
        if(DS == 1):
            ...
            wiringpi.pwmWrite(HorizontalServoPin,_map(90, 0, 180,40, 260))
            wiringpi.pwmWrite(VerticalServoPin, _map(70, 0, 180,40, 260))
            time.sleep(0.2)
